...
static struct clk_lookup msm_clocks_lookup[] = {
	 CLK_LOOKUP_OF("gpll0_clk_src", gpll0_clk_src, NULL),
	 CLK_LOOKUP_OF("gpll0_ao_clk_src", gpll0_ao_clk_src, NULL),
	 ...
	 CLK_LOOKUP_OF("pcnoc_msmbus_a_clk", pcnoc_msmbus_a_clk, NULL),
	 CLK_LOOKUP_OF("pcnoc_keepalive_a_clk", pcnoc_keepalive_a_clk, NULL),
	 CLK_LOOKUP_OF("pcnoc_usb_clk", pcnoc_usb_clk, NULL),
	 CLK_LOOKUP_OF("pcnoc_usb_a_clk", pcnoc_usb_a_clk, NULL),
	 CLK_LOOKUP_OF("bimc_clk", bimc_clk, NULL),
	 CLK_LOOKUP_OF("bimc_a_clk", bimc_a_clk, NULL),
	 CLK_LOOKUP_OF("bimc_msmbus_clk", bimc_msmbus_clk, NULL),
	 CLK_LOOKUP_OF("bimc_msmbus_a_clk", bimc_msmbus_a_clk, NULL),
	 CLK_LOOKUP_OF("bimc_usb_clk", bimc_usb_clk, NULL),
	 CLK_LOOKUP_OF("bimc_usb_a_clk", bimc_usb_a_clk, NULL),
	 CLK_LOOKUP_OF("qdss_clk", qdss_clk, NULL),
	 CLK_LOOKUP_OF("qdss_a_clk", qdss_a_clk, NULL),
	 CLK_LOOKUP_OF("qpic_clk", qpic_clk, NULL),
	 CLK_LOOKUP_OF("qpic_a_clk", qpic_a_clk, NULL),
	 CLK_LOOKUP_OF("xo_clk_src", xo_clk_src, NULL),
	 CLK_LOOKUP_OF("xo_a_clk_src", xo_a_clk_src, NULL),
	 CLK_LOOKUP_OF("xo_otg_clk", xo_otg_clk, NULL),
	 CLK_LOOKUP_OF("xo_lpm_clk", xo_lpm_clk, NULL),
	 CLK_LOOKUP_OF("xo_pil_mss_clk", xo_pil_mss_clk, NULL),

	 CLK_LOOKUP_OF("bb_clk1", bb_clk1, NULL),
	 CLK_LOOKUP_OF("bb_clk1_pin", bb_clk1_pin, NULL),

	 CLK_LOOKUP_OF("gcc_apss_ahb_clk", gcc_apss_ahb_clk, NULL),
	 CLK_LOOKUP_OF("gcc_apss_axi_clk", gcc_apss_axi_clk, NULL),
	 CLK_LOOKUP_OF("gcc_blsp1_ahb_clk", gcc_blsp1_ahb_clk, NULL),
	 CLK_LOOKUP_OF("gcc_boot_rom_ahb_clk", gcc_boot_rom_ahb_clk, NULL),
	 CLK_LOOKUP_OF("gcc_crypto_ahb_clk", gcc_crypto_ahb_clk, NULL),
	 CLK_LOOKUP_OF("gcc_crypto_axi_clk", gcc_crypto_axi_clk, NULL),
	 CLK_LOOKUP_OF("gcc_crypto_clk", gcc_crypto_clk, NULL),
	 CLK_LOOKUP_OF("gcc_prng_ahb_clk", gcc_prng_ahb_clk, NULL),
	 CLK_LOOKUP_OF("gcc_apss_tcu_clk", gcc_apss_tcu_clk, NULL),
	 CLK_LOOKUP_OF("gcc_qdss_dap_clk", gcc_qdss_dap_clk, NULL),
	 CLK_LOOKUP_OF("gcc_smmu_cfg_clk", gcc_smmu_cfg_clk, NULL),
	 CLK_LOOKUP_OF("apss_ahb_clk_src", apss_ahb_clk_src, NULL),
	 CLK_LOOKUP_OF("emac_0_125m_clk_src", emac_0_125m_clk_src, NULL),
	 CLK_LOOKUP_OF("blsp1_qup1_i2c_apps_clk_src", blsp1_qup1_i2c_apps_clk_src, NULL),
	 CLK_LOOKUP_OF("blsp1_qup1_spi_apps_clk_src", blsp1_qup1_spi_apps_clk_src, NULL),
	 CLK_LOOKUP_OF("blsp1_qup2_i2c_apps_clk_src", blsp1_qup2_i2c_apps_clk_src, NULL),
	 CLK_LOOKUP_OF("blsp1_qup2_spi_apps_clk_src", blsp1_qup2_spi_apps_clk_src, NULL),
	 CLK_LOOKUP_OF("blsp1_qup3_i2c_apps_clk_src", blsp1_qup3_i2c_apps_clk_src, NULL),
	 CLK_LOOKUP_OF("blsp1_qup3_spi_apps_clk_src", blsp1_qup3_spi_apps_clk_src, NULL),
	 CLK_LOOKUP_OF("blsp1_qup4_i2c_apps_clk_src", blsp1_qup4_i2c_apps_clk_src, NULL),
	 CLK_LOOKUP_OF("blsp1_qup4_spi_apps_clk_src", blsp1_qup4_spi_apps_clk_src, NULL),
	 CLK_LOOKUP_OF("blsp1_qup5_i2c_apps_clk_src", blsp1_qup5_i2c_apps_clk_src, NULL),
	 CLK_LOOKUP_OF("blsp1_qup5_spi_apps_clk_src", blsp1_qup5_spi_apps_clk_src, NULL),
	 CLK_LOOKUP_OF("blsp1_qup6_i2c_apps_clk_src", blsp1_qup6_i2c_apps_clk_src, NULL),
	 CLK_LOOKUP_OF("blsp1_qup6_spi_apps_clk_src", blsp1_qup6_spi_apps_clk_src, NULL),
	 CLK_LOOKUP_OF("blsp1_uart1_apps_clk_src", blsp1_uart1_apps_clk_src, NULL),
	 CLK_LOOKUP_OF("blsp1_uart2_apps_clk_src", blsp1_uart2_apps_clk_src, NULL),
	 CLK_LOOKUP_OF("blsp1_uart3_apps_clk_src", blsp1_uart3_apps_clk_src, NULL),
	 CLK_LOOKUP_OF("blsp1_uart4_apps_clk_src", blsp1_uart4_apps_clk_src, NULL),
	 CLK_LOOKUP_OF("blsp1_uart5_apps_clk_src", blsp1_uart5_apps_clk_src, NULL),
	 CLK_LOOKUP_OF("blsp1_uart6_apps_clk_src", blsp1_uart6_apps_clk_src, NULL),
	 CLK_LOOKUP_OF("crypto_clk_src", crypto_clk_src, NULL),
	 CLK_LOOKUP_OF("gp1_clk_src", gp1_clk_src, NULL),
	 CLK_LOOKUP_OF("gp2_clk_src", gp2_clk_src, NULL),
	 CLK_LOOKUP_OF("gp3_clk_src", gp3_clk_src, NULL),
	 CLK_LOOKUP_OF("pdm2_clk_src", pdm2_clk_src, NULL),
	 CLK_LOOKUP_OF("sdcc1_apps_clk_src", sdcc1_apps_clk_src, NULL),
	 CLK_LOOKUP_OF("sdcc2_apps_clk_src", sdcc2_apps_clk_src, NULL),
	 CLK_LOOKUP_OF("emac_0_sys_25m_clk_src", emac_0_sys_25m_clk_src, NULL),
	 CLK_LOOKUP_OF("emac_0_tx_clk_src", emac_0_tx_clk_src, NULL),
	 CLK_LOOKUP_OF("usb_hs_system_clk_src", usb_hs_system_clk_src, NULL),
	 CLK_LOOKUP_OF("usb_hsic_clk_src", usb_hsic_clk_src, NULL),
	 CLK_LOOKUP_OF("usb_hsic_io_cal_clk_src", usb_hsic_io_cal_clk_src, NULL),
	 CLK_LOOKUP_OF("usb_hsic_system_clk_src", usb_hsic_system_clk_src, NULL),
	 CLK_LOOKUP_OF("gcc_blsp1_qup1_i2c_apps_clk", gcc_blsp1_qup1_i2c_apps_clk, NULL),
	 CLK_LOOKUP_OF("gcc_blsp1_qup1_spi_apps_clk", gcc_blsp1_qup1_spi_apps_clk, NULL),
	 CLK_LOOKUP_OF("gcc_blsp1_qup2_i2c_apps_clk", gcc_blsp1_qup2_i2c_apps_clk, NULL),
	 CLK_LOOKUP_OF("gcc_blsp1_qup2_spi_apps_clk", gcc_blsp1_qup2_spi_apps_clk, NULL),
	 CLK_LOOKUP_OF("gcc_blsp1_qup3_i2c_apps_clk", gcc_blsp1_qup3_i2c_apps_clk, NULL),
	 CLK_LOOKUP_OF("gcc_blsp1_qup3_spi_apps_clk", gcc_blsp1_qup3_spi_apps_clk, NULL),
	 CLK_LOOKUP_OF("gcc_blsp1_qup4_i2c_apps_clk", gcc_blsp1_qup4_i2c_apps_clk, NULL),
	 CLK_LOOKUP_OF("gcc_blsp1_qup4_spi_apps_clk", gcc_blsp1_qup4_spi_apps_clk, NULL),
	 CLK_LOOKUP_OF("gcc_blsp1_qup5_i2c_apps_clk", gcc_blsp1_qup5_i2c_apps_clk, NULL),
	 CLK_LOOKUP_OF("gcc_blsp1_qup5_spi_apps_clk", gcc_blsp1_qup5_spi_apps_clk, NULL),
	 CLK_LOOKUP_OF("gcc_blsp1_qup6_i2c_apps_clk", gcc_blsp1_qup6_i2c_apps_clk, NULL),
	 CLK_LOOKUP_OF("gcc_blsp1_qup6_spi_apps_clk", gcc_blsp1_qup6_spi_apps_clk, NULL),
	 CLK_LOOKUP_OF("gcc_blsp1_uart1_apps_clk", gcc_blsp1_uart1_apps_clk, NULL),
	 CLK_LOOKUP_OF("gcc_blsp1_uart2_apps_clk", gcc_blsp1_uart2_apps_clk, NULL),
	 CLK_LOOKUP_OF("gcc_blsp1_uart3_apps_clk", gcc_blsp1_uart3_apps_clk, NULL),
	 CLK_LOOKUP_OF("gcc_blsp1_uart4_apps_clk", gcc_blsp1_uart4_apps_clk, NULL),
	 CLK_LOOKUP_OF("gcc_blsp1_uart5_apps_clk", gcc_blsp1_uart5_apps_clk, NULL),
	 CLK_LOOKUP_OF("gcc_blsp1_uart6_apps_clk", gcc_blsp1_uart6_apps_clk, NULL),
	 CLK_LOOKUP_OF("gcc_gp1_clk", gcc_gp1_clk, NULL),
	 CLK_LOOKUP_OF("gcc_gp2_clk", gcc_gp2_clk, NULL),
	 CLK_LOOKUP_OF("gcc_gp3_clk", gcc_gp3_clk, NULL),
	 CLK_LOOKUP_OF("gcc_mss_cfg_ahb_clk", gcc_mss_cfg_ahb_clk, NULL),
	 CLK_LOOKUP_OF("gcc_mss_q6_bimc_axi_clk", gcc_mss_q6_bimc_axi_clk, NULL),
	 CLK_LOOKUP_OF("gcc_pdm2_clk", gcc_pdm2_clk, NULL),
	 CLK_LOOKUP_OF("gcc_pdm_ahb_clk", gcc_pdm_ahb_clk, NULL),
	 CLK_LOOKUP_OF("gcc_sdcc1_ahb_clk", gcc_sdcc1_ahb_clk, NULL),
	 CLK_LOOKUP_OF("gcc_sdcc1_apps_clk", gcc_sdcc1_apps_clk, NULL),
	 CLK_LOOKUP_OF("gcc_sdcc2_ahb_clk", gcc_sdcc2_ahb_clk, NULL),
	 CLK_LOOKUP_OF("gcc_sdcc2_apps_clk", gcc_sdcc2_apps_clk, NULL),
	 CLK_LOOKUP_OF("gcc_emac_0_125m_clk", gcc_emac_0_125m_clk, NULL),
	 CLK_LOOKUP_OF("gcc_emac_0_ahb_clk", gcc_emac_0_ahb_clk, NULL),
	 CLK_LOOKUP_OF("gcc_emac_0_axi_clk", gcc_emac_0_axi_clk, NULL),
	 CLK_LOOKUP_OF("gcc_emac_0_sys_25m_clk", gcc_emac_0_sys_25m_clk, NULL),
	 CLK_LOOKUP_OF("gcc_emac_0_sys_clk", gcc_emac_0_sys_clk, NULL),
	 CLK_LOOKUP_OF("gcc_emac_0_tx_clk", gcc_emac_0_tx_clk, NULL),
	 CLK_LOOKUP_OF("gcc_emac_0_rx_clk", gcc_emac_0_rx_clk, NULL),
	 CLK_LOOKUP_OF("gcc_usb2a_phy_sleep_clk", gcc_usb2a_phy_sleep_clk, NULL),
	 CLK_LOOKUP_OF("gcc_usb_hs_phy_cfg_ahb_clk", gcc_usb_hs_phy_cfg_ahb_clk, NULL),
	 CLK_LOOKUP_OF("gcc_usb_hs_ahb_clk", gcc_usb_hs_ahb_clk, NULL),
	 CLK_LOOKUP_OF("gcc_usb_hs_system_clk", gcc_usb_hs_system_clk, NULL),
	 CLK_LOOKUP_OF("gcc_usb_hsic_ahb_clk", gcc_usb_hsic_ahb_clk, NULL),
	 CLK_LOOKUP_OF("gcc_usb_hsic_clk", gcc_usb_hsic_clk, NULL),
	 CLK_LOOKUP_OF("gcc_usb_hsic_io_cal_clk", gcc_usb_hsic_io_cal_clk, NULL),
	 CLK_LOOKUP_OF("gcc_usb_hsic_io_cal_sleep_clk", gcc_usb_hsic_io_cal_sleep_clk, NULL),
	 CLK_LOOKUP_OF("gcc_usb_hsic_system_clk", gcc_usb_hsic_system_clk, NULL),
	 CLK_LOOKUP_OF("gcc_usb2_hs_phy_only_clk", gcc_usb2_hs_phy_only_clk, NULL),
	 CLK_LOOKUP_OF("gcc_qusb2_phy_clk", gcc_qusb2_phy_clk, NULL),
};

static const struct msm_reset_map gcc_9607_resets[] = {
	[GCC_USB2_HS_PHY_ONLY_BCR]	= { 0x41034 },
	[GCC_QUSB2_PHY_BCR]		= { 0x4103C },
	[GCC_USB_HS_BCR]		= { 0x41000 },
	[GCC_USB_HS_HSIC_BCR]		= { 0x3D05C },
};
...
static int msm_gcc_probe(struct platform_device *pdev)
{
	...
	msm_reset_controller_register(pdev, gcc_9607_resets,
			ARRAY_SIZE(gcc_9607_resets), virt_bases[GCC_BASE]);
