...
#define WM8944_VROI_1Kx 1
	...
	bool idle_bias_off; /* set to true for bias off during idle instead of
			       standby */

	enum wm8944_vmid_mode vmid_mode;

	int dacvol; /* default value for DAC volume */
	int speakvol; /* default value for SPEAKER volume */
};
